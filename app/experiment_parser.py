...
class ExperimentParser:
    ...
    def extract_equipment(self, exp_text: str) -> List[str]:
        ...
        equipment_pattern = r"(?:apparatus|equipment|materials|tools|apparatus required)(?:\s+required)?\s*[:\-]*\s*(.*?)(?=\b(?:equipment|procedure|step|safety|theory|aim|result|observation|conclusion)\b|[.!?]|$)"
